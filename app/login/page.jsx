...
function Login() {
    ...
    console.log("session in login", session.status)
            ...
            <div  className=" space-y-6">
              ...
              <div  className=" bg-white md:w-[400px] p-[30px] font-lato rounded-[20px]  ">
                <form action="" className=" space-y-5 " onSubmit={handleSubmit} >
                  ...
                  <button
                    type="submit"
                    style={{backgroundColor:' #286DE0'}}
                    className=" text-white font-montserrat font-bold text-center py-[10px] w-full rounded-[10px] hover:bg-black/80  "
                  >
                    Sign In
                  </button>
                </form>
